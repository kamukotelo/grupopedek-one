...
const stories: Story[] = [
  ...
  { id: 'operacao-pepek', video: '/videos/operacao-pepek-web.m4v', tag: 'Experiência', title: 'Operação PEPEK — A Excelência Começa nos Bastidores', text: 'Rigor na preparação. Resultado premium em cada viagem.', duration: '27 seg', audience: 'Clientes PEPEK' },
